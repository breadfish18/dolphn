...
const apiPostRelationship = require("../api/post_friendship.js");
const apiEditRelationship = require("../api/edit_friendship.js");
...
router.post("/relationships", apiPostRelationship);
router.post("/relationships/*", apiEditRelationship);
